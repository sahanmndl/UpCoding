...
const UpcomingContestsView = () => {
    ...
    const upcomingContests = selected.length > 0
        ? contests.filter((contest) => contest.status === "BEFORE" && selected.includes(contest.site))
        : contests.filter((contest) => contest.status === "BEFORE");
...
export default UpcomingContestsView
